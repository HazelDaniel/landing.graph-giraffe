...
export const Hero: React.FC = () => {
  return (
    ...
    >
      <p className="absolute top-0 right-4 text-md w-[clamp(8rem,20vw,40rem)] z-1 text-dark">
      ...
      <div className="relative w-full z-1 flex flex-col h-[35rem]">
        ...
        <h2 className="text-6xl capitalize font-gasoek text-center  z-1 mb-8 font-bold leading-[5rem] text-dark">
